...
def get_email_from_google_token(googleToken):
    try:
        ...
        assert tokenResult.get('issued_to') in ['13721498420-qg32kke2kg6g3j1btv6o06a61ufbp885.apps.googleusercontent.com']
        assert tokenResult.get('audience') == '13721498420-410vm5auoa096qrspqqes7cutv5k7clk.apps.googleusercontent.com'
