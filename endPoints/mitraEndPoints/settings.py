"""
Django settings for mitraEndPoints project.
...
SECRET_KEY = 'i)4iq(!aah4!1u&#tm8lnq+wvia9yev__f)f^!vm*^nn%inlz_'
...
ROOT_URLCONF = 'mitraEndPoints.urls'
...
WSGI_APPLICATION = 'mitraEndPoints.wsgi.application'
