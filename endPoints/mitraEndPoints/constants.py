class messages():
    ...
    list_usercontent_contenttype_codeid_cannnot_be_empty = 100142
    ...
    list_usercontent_user_id_not_exists = 100148
    list_usercontent_contenttype_code_id_does_not_exists = 100149
