...
TeachingAidsController.$inject = ['TeachingAidsService','commonService','$scope','$state'];

function TeachingAidsController(TeachingAidsService,commonService,$scope, $state) {
    var vm = this;
